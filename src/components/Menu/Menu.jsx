...
const Menu = ({isMobile, isOpen, setIsOpen}) => {
    ...
    return (
        <NavContainer isMobile={isMobile} isOpen={isOpen}>
            <VisibilityHidden><h2>Menu</h2></VisibilityHidden>
            {isMobile && <Button aria-expanded={isOpen} onClick={toggleMenu}>
...
const NavContainer = styled.nav(({isMobile, isOpen}) => ({
    ...
    transform: isMobile ? (!isOpen ? 'translateX(-180px)' : 'transform: translateX(0)') : null,
